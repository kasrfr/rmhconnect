...
final Color backgroundColor = Color(0xFFF15152);
final TextStyle mytext = TextStyle(fontSize:32, color: Color(0xFFF15152), fontWeight: FontWeight.bold);
...
final TextStyle mytextred = TextStyle(fontSize:18, color: Colors.red);
...
final TextStyle versionStyley = TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 32);
